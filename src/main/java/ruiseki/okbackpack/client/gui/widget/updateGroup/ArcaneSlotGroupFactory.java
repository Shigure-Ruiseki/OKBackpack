...
public class ArcaneSlotGroupFactory implements IUpgradeSlotGroupFactory {
    ...
    public void build(UpgradeSlotUpdateGroup group) {
        ...
        arcaneOutputSlot.setOnCraftCallback(() -> updateInventoryCrafting(arcaneStackHandler, panel));
