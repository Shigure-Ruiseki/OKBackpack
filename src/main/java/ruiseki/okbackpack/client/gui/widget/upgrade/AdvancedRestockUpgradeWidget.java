...
public class AdvancedRestockUpgradeWidget extends AdvancedExpandedTabWidget<AdvancedRestockUpgradeWrapper> {
    ...
    public AdvancedRestockUpgradeWidget(int slotIndex, AdvancedRestockUpgradeWrapper wrapper, ItemStack stack,
        IStoragePanel<?> panel, String titleKey) {
        super(slotIndex, wrapper, stack, panel, titleKey, "adv_restock_filter", 5, 100);
