...
public class AdvancedDepositUpgradeWidget extends AdvancedExpandedTabWidget<AdvancedDepositUpgradeWrapper> {
    ...
    public AdvancedDepositUpgradeWidget(int slotIndex, AdvancedDepositUpgradeWrapper wrapper, ItemStack stack,
        IStoragePanel<?> panel, String titleKey) {
        super(slotIndex, wrapper, stack, panel, titleKey, "adv_deposit_filter", 5, 100);
