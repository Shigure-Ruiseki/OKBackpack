...
public class ItemBookshelfUpgrade extends ItemUpgrade<BookshelfUpgradeWrapper> {
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize("tooltip.backpack.bookshelf_upgrade"));
    }

    @Override
    public UpgradeSlotChangeResult canAddUpgradeTo(IStorageWrapper wrapper, ItemStack upgradeStack, int targetSlot) {
        int[] conflicts = IUpgradeItem.findConflictSlots(wrapper, targetSlot, ItemBookshelfUpgrade.class);
    ...
    @Override
    public BookshelfUpgradeWrapper createWrapper(ItemStack stack, IStorageWrapper storage,
        Consumer<ItemStack> consumer) {
        return new BookshelfUpgradeWrapper(stack, storage, consumer);
    }
}
