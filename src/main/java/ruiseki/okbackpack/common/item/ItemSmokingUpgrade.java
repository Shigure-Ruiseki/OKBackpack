...
import ruiseki.okbackpack.common.item.wrapper.SmokingUpgradeWrapper;
...
public class ItemSmokingUpgrade extends ItemUpgrade<SmokingUpgradeWrapper> {
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize("tooltip.backpack.smoking_upgrade"));
    }

    @Override
    public SmokingUpgradeWrapper createWrapper(ItemStack stack, IStorageWrapper storage) {
        return new SmokingUpgradeWrapper(stack, storage);
    }
