...
public class ItemSurvivalInfinityUpgrade extends ItemUpgrade<InfinityUpgradeWrapper> {
    ...
    public ItemSurvivalInfinityUpgrade() {
        super("survival_infinity_upgrade");
        setMaxStackSize(1);
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize("tooltip.backpack.survival_infinity_upgrade"));
        list.add(LangHelpers.localize("tooltip.backpack.survival_infinity_upgrade.1"));
    }
