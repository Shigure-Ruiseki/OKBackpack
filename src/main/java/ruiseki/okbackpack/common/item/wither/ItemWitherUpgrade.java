...
public class ItemWitherUpgrade extends ItemUpgrade<WitherUpgradeWrapper> {

    public ItemWitherUpgrade() {
        super("wither_upgrade");
        setMaxStackSize(1);
        setTextureName(Reference.PREFIX_MOD + "wither_upgrade");
    }

    @Override
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize("tooltip.backpack.wither_upgrade"));
        list.add(LangHelpers.localize("tooltip.backpack.wither_upgrade.1"));
    }
    ...
    @Override
    public WitherUpgradeWrapper createWrapper(ItemStack stack, IStorageWrapper storage, Consumer<ItemStack> consumer) {
        return new WitherUpgradeWrapper(stack, storage, consumer);
    }
}
